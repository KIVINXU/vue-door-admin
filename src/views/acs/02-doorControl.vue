<template>
  <div>
    ...
    <el-row>
      <el-col>
        <el-table :data="list" ref="doorControlTable"
                  highlight-current-row
                  @current-change="handleCurrentChange"
                  border>
          <el-table-column prop="id" :show-overflow-tooltip="true" label="编号"></el-table-column>
          <el-table-column prop="apartment" :show-overflow-tooltip="true" label="部门"></el-table-column>
          <el-table-column prop="name" :show-overflow-tooltip="true" label="姓名"></el-table-column>
          <el-table-column prop="idnum" :show-overflow-tooltip="true" label="身份证"></el-table-column>
