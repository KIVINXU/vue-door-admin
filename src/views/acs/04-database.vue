    ...
    <el-row>
      <el-col>
        <el-table :data="list" ref="cabinetsTable"
                  ...
                  border>
          <el-table-column prop="id" :show-overflow-tooltip="true" label="用户编号">
          </el-table-column>
          <el-table-column prop="name" :show-overflow-tooltip="true" label="姓名"></el-table-column>
          <el-table-column prop="deivceno" :show-overflow-tooltip="true" label="站点编号"></el-table-column>
          <el-table-column prop="devicename" :show-overflow-tooltip="true" label="站点名称"></el-table-column>
          <el-table-column prop="ctime" :show-overflow-tooltip="true" label="时间"></el-table-column>
