    ...
    <el-row>
      <el-col>
        <el-table :data="list" ref="cabinetsTable"
          ...
          <el-table-column prop="permission" :show-overflow-tooltip="true" label="权限"></el-table-column>
          <el-table-column prop="flag" :show-overflow-tooltip="true" label="状态"></el-table-column>
          <el-table-column prop="guarder" :show-overflow-tooltip="true" label="责任人"></el-table-column>
          <el-table-column prop="contact" :show-overflow-tooltip="true" label="联系方式"></el-table-column>
        ...
        <el-row>
          <el-col :sm="24" :md="12">
            ...
            <el-form-item label="状态" prop="flag">
              <el-input v-model.trim="temp.name" :maxlength="5"></el-input>
            </el-form-item>
          </el-col>
          <el-col :sm="24" :md="12">
            <el-form-item label="部门" prop="apartment">
              <el-input v-model.trim="temp.place" :maxlength="18"></el-input>
            </el-form-item>
            <el-form-item label="身份证" prop="idnum">
              <el-input v-model.trim="temp.idnum" :maxlength="18"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
