<template>
  <div>
    ...
    <el-row>
      <el-col>
        <el-table :data="list" border
          ...
          <el-table-column prop="id" width="180" :show-overflow-tooltip="true" label="设备编号"></el-table-column>
          <el-table-column prop="name" :show-overflow-tooltip="true" label="设备名称"></el-table-column>
          <!--<el-table-column prop="ip" :show-overflow-tooltip="true" label="IP地址"></el-table-column>-->
          <el-table-column prop="model" :show-overflow-tooltip="true" label="设备型号" width="100"></el-table-column>
          <el-table-column prop="place" width="220" :show-overflow-tooltip="true" label="安装位置"></el-table-column>
          <!--<el-table-column prop="username" :show-overflow-tooltip="true" label="访问用户"></el-table-column>-->
          <!--<el-table-column prop="passwd" :show-overflow-tooltip="true" label="访问密码"></el-table-column>-->
          <el-table-column prop="maxnum" :show-overflow-tooltip="true" label="在用箱子数" width="80"></el-table-column>
          ...
          <!--<el-table-column prop="mtime" :show-overflow-tooltip="true" label="更改日期" width="140"></el-table-column>-->
          <!--<el-table-column prop="ctime" :show-overflow-tooltip="true" label="创建日期" width="140"></el-table-column>-->
    ...
    <el-dialog title="提示" :visible.sync="deleteDialogVisible" width="30%">
      <span><i class="el-icon-warning"></i>是否确认删除【{{deleteName}}】的数据？确认删除后，将不能恢复！</span>
        ...
        <el-row>
          <el-col :sm="24" :md="24">
            ...
            <el-form-item label="设备型号" prop="model">
              <el-input v-model.trim="temp.model" :maxlength="16"></el-input>
            </el-form-item>
            <el-form-item label="安装位置" prop="place">
              <el-input v-model.trim="temp.place" :maxlength="32"></el-input>
            </el-form-item>
            <!--<el-form-item label="IP地址" prop="ip">-->
              <!--<el-input v-model.trim="temp.ip" :maxlength="15"></el-input>-->
            <!--</el-form-item>-->
            <!--<el-form-item label="端口号" prop="port">-->
              <!--<el-input v-model.trim="temp.port" :maxlength="4"></el-input>-->
            <!--</el-form-item>-->
          </el-col>
          <!--<el-col :sm="24" :md="12">-->
            ...
            <!--<el-form-item label="访问密码" prop="passwd">-->
              <!--<el-input v-model.trim="temp.passwd" :maxlength="16"></el-input>-->
            <!--</el-form-item>-->
            <!--<el-form-item label="箱子数" prop="maxnum">-->
              <!--<el-input type="number" v-model.trim="temp.maxnum" :maxlength="2"></el-input>-->
            <!--</el-form-item>-->
          <!--</el-col>-->
        </el-row>
        <el-form-item label="基本参数" prop="param">
          <el-input type="textarea" :maxlength="64"
                    v-model.trim="temp.param"
                    :autosize="{ minRows: 1, maxRows: 4 }">
          </el-input>
        </el-form-item>
        <el-form-item label="扩展参数" prop="exparam">
          <el-input type="textarea" :maxlength="192"
                    v-model.trim="temp.exparam"
                    :autosize="{ minRows: 1, maxRows: 4 }">
          </el-input>
        </el-form-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      //请求后台
      requestList (List){
        fetchList('/cab/eqpHome', List).then( response => {
...
//            });
      ...
      handleFocus() {
        if(this.searchOption.length === 0) {
          fetchSearchOption('/cab/eqpHome',{method: 'FieldQuery'})
            .then(response => {
            const data = response.data;
            if(data.msg && data.msg !== ''){
              this.$message({
      ...
      createData() {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            ...
            delete temp.maxnum;
            SubmitTable('/cab/eqpHome', temp).then(response => {
              const data = response.data;
              if(data.msg && data.msg !== ''){
                this.$message({
                  showClose: true,
      ...
      rowDelete(index, row) {
        ...
        SubmitTable('/cab/eqpHome', deleteData).then(response => {
          const data = response.data;
          if(data.msg && data.msg !== ''){
            this.$message({
              showClose: true,
